...
const upload = multer({ storage: exports.storage });
app.post('/users/register', upload.single('file'), (req, res) => new user_controller_1.UserController().register(req, res, fileName));
